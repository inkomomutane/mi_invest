...
watch(searchTerm, (value) => {
    router.visit(
        route("property.not.approved.all", {
            search: value ?? "",
        }),
        {
            only: ["properties"],
...
const refuseProperty = (property: App.Data.PropertyData) =>
    useForm({
        approve: false,
    }).post(
        route("property.approvment", {
            property: property.slug,
        })
    );
const approveProperty = (property: App.Data.PropertyData) =>
    useForm({
        approve: true,
    }).post(
        route("property.approvment", {
