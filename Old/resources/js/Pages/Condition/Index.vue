...
const links = ref(props.conditions.links);

const editingConditionTrigger = ref(false);
const editingCondition = ref<App.Data.ConditionData | null>(null);

const deletingConditionTrigger = ref(false);
const deletingCondition = ref<App.Data.ConditionData | null>(null);
...
function openEditConditionModal(condition: App.Data.ConditionData) {
    editingCondition.value = condition;
    editingConditionTrigger.value = true;
}

function closeEditConditionModal() {
    editingCondition.value = null;
    editingConditionTrigger.value = false;
}

function openDeleteConditionModal(condition: App.Data.ConditionData) {
    deletingCondition.value = condition;
    deletingConditionTrigger.value = true;
}

function closeDeleteConditionModal() {
    deletingCondition.value = null;
    deletingConditionTrigger.value = false;
}
</script>
    ...
    <AuthenticatedLayout>
        <template v-slot:content>
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                ...
                                >{{
                                    `${conditions.meta.from ?? 0}-${
                                        conditions.meta.to ?? 0
                                    }`
                                }}</span
                            >
                            of
            ...
            <EditCondition
                ...
                :openModal="editingConditionTrigger"
                :close="closeEditConditionModal"
            />
            <DeleteCondition
                v-if="deletingCondition"
                :condition="deletingCondition"
                :openModal="deletingConditionTrigger"
                :close="closeDeleteConditionModal"
            />
        </template>
    </AuthenticatedLayout>
</template>
