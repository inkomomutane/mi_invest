...
const crudManagerRef = ref(crudManager<App.Data.ProvinceData>());
const editManagerRef = ref(crudManager<App.Data.ProvinceData>());
const deleteManagerRef = ref(crudManager<App.Data.ProvinceData>());

const tableData = ref<App.Data.ProvinceData[]>([]);
watch(
...
const columnHelper = createColumnHelper<App.Data.ProvinceData>();
const columns = [
