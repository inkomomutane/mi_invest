...
const form = useForm({
    ...
    prefix: props.transactionType.prefix,
    images: [] as File[],
});
            ...
            <div>
                <form @submit.prevent="submit">
                    <div class="grid gap-4">
                        ...
                        <div class="grid w-full items-center gap-1.5">
                            <Label for="prefix" class="text-sm font-medium text-gray-700 dark:text-gray-300">
                                {{ $t('Prefix') }}
                            </Label>
                            <Input
                                id="prefix"
                        ...
                        <div v-if="transactionType.icon?.original_url" class="grid w-full items-center gap-1.5">
