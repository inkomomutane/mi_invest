...
const props = defineProps({
    condition: {
        type: Object as PropType<App.Data.ConditionData>,
        required: true,
    },
    close: {
        type: Function,
...
const nomeInput = ref<String | any>(props.condition.nome);

const form = useForm({
    id: props.condition.id,
    nome: props.condition.nome,
});

const updateCondition = () => {
    form.patch(
        route("condition.update", {
            condition: props.condition.id as number,
        }),
        {
            preserveScroll: true,
            onSuccess: () => {
    ...
    <Modal :show="props.openModal" @close="props.close">
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <form class="space-y-6" @submit.prevent="updateCondition">
                    <div>
                        <label
                            for="nome"
