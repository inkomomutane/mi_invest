...
const addBusinessRule = ref(false);
const nameInput = ref();
const addBusinessRuleTrigger = () => {
    addBusinessRule.value = true;
};

const closeCreateProvinceModal = () => {
    addBusinessRule.value = false;
};
...
<template>
    ...
    <Modal :show="addBusinessRule" @close="closeCreateProvinceModal">
